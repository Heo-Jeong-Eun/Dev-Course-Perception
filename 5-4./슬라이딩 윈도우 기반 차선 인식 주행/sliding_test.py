# VideoCapture() 인자값을 동영상 경로로 설정해주시면 실행 가능합니다!
# 변경한 소스 코드는 녹색 배경으로 표시해두었습니다.
...
capture = cv2.VideoCapture("C:/Users/HP/Desktop/ws/track2.avi")
...
def warp_process_image(image):
    ...
    dividen_lane = np.split(lane, 10, axis = 0) # lane 이미지를 각 sliding window마다 적용 가능하도록 10개로 자름
