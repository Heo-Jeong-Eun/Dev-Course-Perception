...
private:
    ...
    PREC mProportionalGainError = 0.0f; ///< Error to determine how much the proportional gain should be reflected
    PREC mIntegralGainError = 0.0f;     ///< Error to determine how much the integral gain should be reflected
    PREC mDifferentialGainError = 0.0f; ///< Error to determine how much the differential gain should be reflected
};
} // namespace Xycar
