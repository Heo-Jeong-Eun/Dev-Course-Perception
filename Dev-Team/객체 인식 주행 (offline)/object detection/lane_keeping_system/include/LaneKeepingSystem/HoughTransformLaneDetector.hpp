...
public:
    ...
    static inline const cv::Scalar kPurple = { 255, 0, 255 }; ///< Scalar values of Blue
    static inline const cv::Scalar kYellow = { 0, 255, 255 }; ///< Scalar values of Blue
...
private:
    ...
    int32_t mRightLineGap;
    int32_t mRightLineForecast;
    int32_t mLeftLineGap;
    int32_t mLeftLineForecast;
